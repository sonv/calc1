+++
title = "Schedule"
description = "Weekly map for MT1003 Calculus 1."
weight = 10
+++
...
|---|---|---|---|
| DTQ1 | Mon-Wed | 13:00-15:50 | B4-505 |
| DT02 | Tue-Thu | 12:00-14:50 | C5-HOITRUONG |

## Session Map

| Session | Topic | Lecture Source | Student Reading / Practice |
|---:|---|---|---|
...
| 9 | Applications of definite integrals | Active Calculus applications | OpenStax applications; Stewart application problems |
| 10 | Improper integrals | Instructor notes; OpenStax support | OpenStax improper integrals; Stewart practice |
| 11 | Introduction to ODEs; separable first-order ODEs | Active Calculus differential equations | OpenStax differential equations |
...
| Lớp | Ngày | Giờ | Phòng |
|---|---|---|---|
| DTQ1 | Thứ Hai-Thứ Tư | 13:00-15:50 | B4-505 |
| DT02 | Thứ Ba-Thứ Năm | 12:00-14:50 | C5-HOITRUONG |

## Bản đồ buổi học

| Buổi | Chủ đề | Nguồn bài giảng | Bài đọc / luyện tập |
|---:|---|---|---|
...
| 9 | Ứng dụng của tích phân xác định | Active Calculus phần ứng dụng | OpenStax phần ứng dụng; bài tập ứng dụng trong Stewart |
| 10 | Tích phân suy rộng | Ghi chú của giảng viên; OpenStax hỗ trợ | OpenStax phần tích phân suy rộng; bài tập Stewart |
| 11 | Giới thiệu phương trình vi phân; phương trình vi phân cấp một tách biến | Active Calculus phần phương trình vi phân | OpenStax phần phương trình vi phân |
